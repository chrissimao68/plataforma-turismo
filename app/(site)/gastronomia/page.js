...
export default async function GastronomiaPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <section className="relative h-[460px] bg-[url('/gastrocapa.jpg')] bg-cover bg-center">
        ...
        <div className="relative mx-auto flex h-full max-w-6xl flex-col justify-center px-6 text-white">
          ...
          <p className="mt-4 max-w-xl text-lg">
            Descubra a riqueza da gastronomia local em Lavras.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-4 justify-items-center rounded-2xl bg-white p-6 shadow md:grid-cols-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Locais de gastronomia</p>
            </div>
          </div>
