...
export default async function GastronomiaPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-900 transition-colors dark:bg-zinc-950 dark:text-zinc-100">
      <section className="relative h-[460px] overflow-hidden bg-[url('/gastrocapa.jpg')] bg-cover bg-center">
        <div className="absolute inset-0 bg-black/55" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />

        <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-center px-6 text-white">
          <span className="mb-4 w-fit rounded-full bg-orange-600/90 px-4 py-2 text-sm font-bold tracking-wide shadow dark:bg-orange-500/90">
            GASTRONOMIA
          </span>
      ...
      <section className="relative z-20 mx-auto -mt-14 max-w-7xl px-6">
        <div className="grid gap-4 rounded-3xl border border-zinc-200 bg-white p-6 shadow-xl transition-colors dark:border-zinc-800 dark:bg-zinc-900 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-300">
              <Utensils size={24} />
            </div>
        ...
        <section className="mx-auto mt-12 max-w-7xl px-6">
          <div className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm transition-colors dark:border-zinc-800 dark:bg-zinc-900 md:grid md:grid-cols-3">
            <div className="p-8">
              ...
              <h2 className="mt-3 text-3xl font-bold text-orange-900 dark:text-orange-300">
                {destaque.titulo}
              </h2>
