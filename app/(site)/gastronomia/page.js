...
export default async function GastronomiaPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-zinc-50 text-zinc-900 transition-colors dark:bg-zinc-950 dark:text-zinc-100">
      <section className="relative min-h-[380px] overflow-hidden bg-[url('/gastrocapa.jpg')] bg-cover bg-center sm:min-h-[430px] lg:min-h-[460px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[380px] w-full max-w-7xl flex-col justify-center px-4 py-12 text-white sm:min-h-[430px] sm:px-6 lg:min-h-[460px] lg:px-8">
          <span className="mb-4 w-fit rounded-full bg-orange-600/90 px-4 py-2 text-xs font-bold uppercase tracking-wide shadow dark:bg-orange-500/90 sm:text-sm">
            Gastronomia
          </span>
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-white/90 sm:text-lg sm:leading-8">
            Descubra sabores, restaurantes, cafés e experiências gastronômicas
            de Lavras.
          </p>
        </div>
      </section>
        ...
        <section className="mx-auto mt-10 w-full max-w-7xl px-4 sm:px-6 lg:mt-12 lg:px-8">
          <div className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm transition-colors dark:border-zinc-800 dark:bg-zinc-900 lg:grid lg:grid-cols-3">
            <div className="p-6 sm:p-8">
              <p className="text-xs font-bold uppercase tracking-wide text-orange-700 dark:text-orange-400 sm:text-sm">
                Destaque da categoria
              </p>

              <h2 className="mt-3 text-2xl font-bold text-orange-900 dark:text-orange-300 sm:text-3xl">
                {destaque.titulo}
              </h2>
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-orange-600 px-5 py-3 font-semibold text-white transition hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-400"
              >
                Ver detalhes
                <ArrowRight size={18} />
              </Link>
      ...
      <section className="mx-auto mt-12 w-full max-w-7xl px-4 sm:px-6 lg:mt-14 lg:px-8">
        <h2 className="text-2xl font-bold text-orange-900 dark:text-orange-300 sm:text-3xl">
          Locais de gastronomia
        </h2>

        <p className="mt-2 text-sm leading-7 text-zinc-600 dark:text-zinc-400 sm:text-base">
          Explore os pontos gastronômicos cadastrados em Lavras.
        </p>
        ...
        {pontos.length > 0 ? (
          ...
          <div className="mt-8 rounded-2xl border border-zinc-200 bg-white p-8 text-center text-sm text-zinc-500 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400 sm:p-10 sm:text-base">
            Nenhum local de gastronomia publicado ainda.
          </div>
        )}
      </section>
