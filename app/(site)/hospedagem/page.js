...
export default async function HospedagemPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-900 transition-colors dark:bg-zinc-950 dark:text-zinc-100">
      <section className="relative h-[460px] overflow-hidden bg-[url('/hospecapa.jpg')] bg-cover bg-center">
        <div className="absolute inset-0 bg-black/55" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />

        <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-center px-6 text-white">
          <span className="mb-4 w-fit rounded-full bg-sky-700/90 px-4 py-2 text-sm font-bold tracking-wide shadow dark:bg-sky-500/90">
            HOSPEDAGEM
          </span>
      ...
      {destaque && (
        <section className="mx-auto mt-12 max-w-7xl px-6">
          <div className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm transition-colors dark:border-zinc-800 dark:bg-zinc-900 md:grid md:grid-cols-3">
            <div className="p-8">
              <p className="text-sm font-bold tracking-wide text-sky-700 dark:text-sky-400">
                DESTAQUE DA CATEGORIA
              </p>

              <h2 className="mt-3 text-3xl font-bold text-sky-900 dark:text-sky-300">
                {destaque.titulo}
              </h2>
      ...
      <section className="mx-auto mt-14 max-w-7xl px-6">
        <h2 className="text-3xl font-bold text-sky-900 dark:text-sky-300">
          Locais de hospedagem
        </h2>
