...
export default async function HospedagemPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-zinc-50 text-zinc-900 transition-colors dark:bg-zinc-950 dark:text-zinc-100">
      <section className="relative min-h-[380px] overflow-hidden bg-[url('/hospecapa.jpg')] bg-cover bg-center sm:min-h-[430px] lg:min-h-[460px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[380px] w-full max-w-7xl flex-col justify-center px-4 py-12 text-white sm:min-h-[430px] sm:px-6 lg:min-h-[460px] lg:px-8">
          <span className="mb-4 w-fit rounded-full bg-sky-700/90 px-4 py-2 text-xs font-bold uppercase tracking-wide shadow dark:bg-sky-500/90 sm:text-sm">
            Hospedagem
          </span>
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-white/90 sm:text-lg sm:leading-8">
            Encontre hotéis, pousadas e opções confortáveis para aproveitar
            Lavras com tranquilidade.
          </p>
        </div>
      </section>
        ...
        <section className="mx-auto mt-10 w-full max-w-7xl px-4 sm:px-6 lg:mt-12 lg:px-8">
          <div className="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm transition-colors dark:border-zinc-800 dark:bg-zinc-900 lg:grid lg:grid-cols-3">
            <div className="p-6 sm:p-8">
              <p className="text-xs font-bold uppercase tracking-wide text-sky-700 dark:text-sky-400 sm:text-sm">
                Destaque da categoria
              </p>

              <h2 className="mt-3 text-2xl font-bold text-sky-900 dark:text-sky-300 sm:text-3xl">
                {destaque.titulo}
              </h2>
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-sky-700 px-5 py-3 font-semibold text-white transition hover:bg-sky-800 dark:bg-sky-500 dark:hover:bg-sky-400"
              >
                Ver detalhes
                <ArrowRight size={18} />
              </Link>
      ...
      <section className="mx-auto mt-12 w-full max-w-7xl px-4 sm:px-6 lg:mt-14 lg:px-8">
        <h2 className="text-2xl font-bold text-sky-900 dark:text-sky-300 sm:text-3xl">
          Locais de hospedagem
        </h2>

        <p className="mt-2 text-sm leading-7 text-zinc-600 dark:text-zinc-400 sm:text-base">
          Explore os pontos de hospedagem cadastrados em Lavras.
        </p>
        ...
        {pontos.length > 0 ? (
          ...
          <div className="mt-8 rounded-2xl border border-zinc-200 bg-white p-8 text-center text-sm text-zinc-500 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400 sm:p-10 sm:text-base">
            Nenhum local de hospedagem publicado ainda.
          </div>
        )}
      </section>
