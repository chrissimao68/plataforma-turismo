...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-zinc-50 to-orange-50 p-4 md:p-8">
      <section className="relative mx-auto flex min-h-[calc(100vh-4rem)] w-[90%] items-center justify-center overflow-hidden rounded-[2rem] shadow-2xl md:rounded-[3rem]">
        <img
          src="/logincapa.jpg"
          alt="Turismo Lavras"
        ...
        <div className="relative z-10 grid w-full gap-10 px-6 py-10 lg:grid-cols-2 lg:px-16">
            ...
            <div className="mt-12 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/75">Acompanhe e aprove comentários</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-xl rounded-[2rem] border border-white/30 bg-white/65 p-6 shadow-2xl backdrop-blur-xl md:p-10">
              <div className="mb-8 text-center">
                <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-white/70 text-emerald-700 shadow-lg">
                  <Lock size={36} />
                </div>
              ...
              <div className="mb-8 grid grid-cols-2 rounded-2xl bg-white/80 p-1 shadow-inner">
                <button
                  type="button"
              ...
              {modo === "login" ? (
                <form action={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <div className="flex items-center gap-3 rounded-xl bg-white/85 px-4 py-4 shadow-sm ring-1 ring-black/5 transition focus-within:ring-2 focus-within:ring-emerald-600">
                      ...
                      <input
                        ...
                        name="usuario"
                        required
                        className="w-full bg-transparent text-emerald-950 outline-none placeholder:text-zinc-500"
                  ...
                  <button
                    disabled={loading}
                    className="flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-emerald-700 via-emerald-600 to-green-700 py-4 font-bold text-white shadow-lg shadow-emerald-900/20 transition hover:scale-[1.01] hover:brightness-110 disabled:opacity-50"
                  >
                    <LogIn size={22} />
                    {loading ? "Entrando..." : "Entrar"}
                  </button>

                  <div className="flex items-center justify-center gap-2 pt-2 text-sm font-medium text-emerald-950/70">
                    <ShieldCheck size={18} />
                ...
                <form action={handleCadastro} className="space-y-6">
                  ...
                  <button
                    disabled={loading}
                    className="flex w-full items-center justify-center gap-3 rounded-xl bg-gradient-to-r from-sky-700 via-sky-600 to-blue-700 py-4 font-bold text-white shadow-lg shadow-sky-900/20 transition hover:scale-[1.01] hover:brightness-110 disabled:opacity-50"
                  >
                    <UserPlus size={22} />
